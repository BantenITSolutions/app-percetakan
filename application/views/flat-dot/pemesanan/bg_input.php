...
<<<<<<< HEAD
			<?php echo form_open("dashboard/pemesanan/simpan",'class="form-horizontal" name="frm_pesan"'); ?>
=======
			<?php echo form_open("dashboard/pemesanan/simpan",'class="form-horizontal"'); ?>
>>>>>>> 30b93fd26dcb762b9b13b0dde45342c45bc14713
			  <fieldset>
...
<<<<<<< HEAD
				...
				<div class="control-group">
				  ...
				  <div class="controls">
					<input type="text" class="input-xlarge" id="uang_muka" name="uang_muka" onChange="hitSisa()" required />
=======
				  <label class="control-label">Jenis Cetakan</label>
				  <div class="controls">
				  	<?php
				  		foreach($jenis_cetakan->result_array() as $jc)
						{
					?>
...
<<<<<<< HEAD
				  ...
				  <div class="controls">
					<input type="text" class="input-xlarge" id="sisa_bayar" name="sisa_bayar" />
=======
